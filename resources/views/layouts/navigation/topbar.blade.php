...
<header class="h-16 bg-white/80 backdrop-blur-sm border-b border-gray-200/60 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-40 transition-all">
    ...
    <div class="flex items-center gap-3 sm:gap-4">
        ...
        <img src="{{ asset('images/dekan.jpg') }}" alt="Prof. Dr. Dekan FMIPA" class="w-9 h-9 rounded-full object-cover shadow-md ring-2 ring-purple-300 border border-purple-100">
    </div>
</header>
