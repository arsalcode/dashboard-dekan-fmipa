...
@section('title', 'Wakil Dekan 1 - Bidang Akademik')
...
<div class="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
    ...
    <div id="wadek1Sections" class="space-y-8">
        ...
        @include('pages.wadek1.partials.ipk-kelulusan')

        <!-- 2. Retensi & Progres Tugas Akhir -->
        @include('pages.wadek1.partials.retensi-tugas-akhir')

        <!-- 3. Akreditasi & Beban Mengajar -->
        @include('pages.wadek1.partials.akreditasi-beban-mengajar')
    </div>
</div>
@endsection
