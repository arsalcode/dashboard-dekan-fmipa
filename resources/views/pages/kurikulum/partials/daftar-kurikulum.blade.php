<!-- Section 2: Daftar Kurikulum FMIPA (Patokan Desain Dosen) -->
<x-shared.section-card title="Daftar Kurikulum FMIPA" icon="fa-solid fa-book-bookmark" sectionClass="section-kurikulum">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 w-full pb-2 border-b border-white/15">
                <div class="relative min-w-[280px] flex-1 max-w-md">
                    ...
                    <input type="text" id="searchKurikulum" placeholder="Cari berdasarkan nama MK, kode, atau dosen..." class="search-kurl-input" />
                </div>

                <div class="flex items-center gap-3 flex-wrap">
                    <button type="button" id="btnSalinPeriode" class="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/15 hover:bg-white/25 text-white font-bold text-xs shadow-xs border border-white/25 backdrop-blur-md transition active:scale-95 cursor-pointer">
                        <i class="fa-solid fa-clone text-amber-300"></i>
                        <span>Salin ke Periode Baru</span>
                    </button>

                <div class="flex items-center gap-2 text-white text-xs font-semibold">
                    <span class="text-purple-200">Tampilkan</span>
                    <div class="table-pagesize-dropdown" id="wrapPageSizeKurikulum">
                        <input type="hidden" id="pageSizeKurikulum" value="10">
            ...
            <div class="p-2 sm:p-2.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl max-w-full overflow-x-auto no-scrollbar shadow-inner shadow-white/5 flex items-center gap-2" id="dataKurlProdiTabs">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-white">
                <div class="flex items-center gap-2 flex-wrap" id="kurlKategoriFilterGroup">
                    ...
                    <button type="button" class="btn-data-kategori-pill" data-kategori-target="wajib">
                        <i class="fa-solid fa-award text-xs"></i>
                        <span>MK Wajib</span>
                    </button>
                    <button type="button" class="btn-data-kategori-pill" data-kategori-target="pilihan">
                        <i class="fa-solid fa-shapes text-xs"></i>
                        <span>MK Pilihan</span>
                    </button>
                </div>

                <div id="labelKurlCountBadge" class="inline-flex items-center px-3.5 py-1.5 rounded-full bg-white/15 border border-white/25 text-xs font-bold text-white shadow-xs">
                    44 Mata Kuliah Terdaftar
                </div>
            </div>

            <!-- Tabel Data Kurikulum (White Card Container matching Dosen) -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse text-xs" id="tabelDataKurikulum">
                        <thead>
                            <tr class="bg-slate-50 border-b border-gray-200 text-gray-600 uppercase text-[10.5px] font-bold tracking-wider whitespace-nowrap">
                                ...
                                <th class="py-3 px-3">Fakultas</th>
                                <th class="py-3 px-3.5">Program Studi</th>
                                <th class="py-3 px-3 font-mono">Kode MK</th>
                                <th class="py-3 px-4 min-w-[200px]">Nama Mata Kuliah</th>
                                <th class="py-3 px-3 text-center">Periode</th>
                                <th class="py-3 px-2 text-center">Sem</th>
                                <th class="py-3 px-2 text-center">SKS</th>
                                <th class="py-3 px-3.5">Koordinator</th>
                                <th class="py-3 px-3.5">Dosen Pengajar</th>
                                <th class="py-3 px-3 text-center">Status</th>
                                <th class="py-3 px-3 text-center w-24">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 font-medium text-gray-700" id="tbodyKurikulum">
                            <!-- Populated dynamically via kurikulum.js -->
                        </tbody>
                    </table>
                </div>
                ...
                <div class="p-4 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500 bg-gray-50/50">
                    <div id="tableInfoKurikulum">Menampilkan 1 - 10 dari 44 data</div>
                    <div class="flex items-center gap-1.5" id="paginationKurikulum">
