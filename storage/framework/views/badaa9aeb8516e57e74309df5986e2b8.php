...
<aside id="sidebar" class="sidebar fixed md:relative z-50 w-64 h-full flex flex-col min-h-0 shadow-2xl flex-shrink-0 transition-all duration-300 -translate-x-full md:translate-x-0">
    ...
    <div class="flex items-center gap-3">
      ...
      <div class="relative flex-shrink-0">
        <div id="logoContainer" class="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center text-white font-bold text-sm shadow-md overflow-hidden border border-white/20">
          <img id="logoImage" src="<?php echo e(asset('images/logo/logo_unpak.png')); ?>" alt="UNPAK Logo" class="w-full h-full p-1 object-contain" onerror="this.classList.add('hidden'); document.getElementById('logoFallback').classList.remove('hidden');" />
  ...
  <nav id="sidebarNav" class="px-3 py-4 flex-1 min-h-0 overflow-y-auto">
    ...
    <!-- Dashboard -->
    <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
    ...
    <a href="<?php echo e(url('/kelola-data')); ?>" class="sidebar-link <?php echo e(request()->is('kelola-data*') || request()->is('upload-data*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200" title="Pusat Upload Berkas Excel & Input Data">
      <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
    ...
    <div id="wakilDekanMenu" class="sidebar-dropdown-menu" data-open="true">
      <!-- Akademik (Wadek 1) -->
      <a href="<?php echo e(url('/wadek-1')); ?>" class="sidebar-link <?php echo e(request()->is('wadek-1*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <a href="<?php echo e(url('/wadek-2')); ?>" class="sidebar-link <?php echo e(request()->is('wadek-2*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <a href="<?php echo e(url('/wadek-3')); ?>" class="sidebar-link <?php echo e(request()->is('wadek-3*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
    ...
    <div id="dataOperasionalMenu" class="sidebar-dropdown-menu" data-open="true">
      <!-- Dosen -->
      <a href="<?php echo e(url('/dosen')); ?>" class="sidebar-link <?php echo e(request()->is('dosen*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Mahasiswa -->
      <a href="<?php echo e(url('/mahasiswa')); ?>" class="sidebar-link <?php echo e(request()->is('mahasiswa*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Kurikulum -->
      <a href="<?php echo e(url('/kurikulum')); ?>" class="sidebar-link <?php echo e(request()->is('kurikulum*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Penelitian -->
      <a href="<?php echo e(url('/penelitian')); ?>" class="sidebar-link <?php echo e(request()->is('penelitian*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Web & Medsos -->
      <a href="<?php echo e(url('/web-medsos')); ?>" class="sidebar-link <?php echo e(request()->is('web-medsos*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Instagram Analytics -->
      <a href="<?php echo e(url('/instagram-analytics')); ?>" class="sidebar-link <?php echo e(request()->is('instagram-analytics*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Kerjasama -->
      <a href="<?php echo e(url('/kerjasama')); ?>" class="sidebar-link <?php echo e(request()->is('kerjasama*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Partisipasi -->
      <a href="<?php echo e(url('/partisipasi')); ?>" class="sidebar-link <?php echo e(request()->is('partisipasi*') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
    ...
    <div id="unitBisnisMenu" class="sidebar-dropdown-menu" data-open="true">
      ...
      <a href="<?php echo e(url('/unit-bisnis')); ?>" class="sidebar-link <?php echo e(request()->is('unit-bisnis') ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- ComSTraC & DSC -->
      <a href="<?php echo e(url('/comstrac-dsc')); ?>" class="sidebar-link <?php echo e((request()->is('comstrac-dsc*') || request()->is('unit-bisnis/comstrac*')) ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Kesehatan & Apotek -->
      <a href="<?php echo e(url('/kesehatan-apotek')); ?>" class="sidebar-link <?php echo e((request()->is('kesehatan-apotek*') || request()->is('unit-bisnis/kesehatan-apotek*')) ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Lab GIS Terpadu -->
      <a href="<?php echo e(url('/lab-gis')); ?>" class="sidebar-link <?php echo e((request()->is('lab-gis*') || request()->is('unit-bisnis/lab-gis*')) ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
      ...
      <!-- Lab Service -->
      <a href="<?php echo e(url('/lab-service')); ?>" class="sidebar-link <?php echo e((request()->is('lab-service*') || request()->is('unit-bisnis/lab-service*')) ? 'active' : ''); ?> group flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-all duration-200">
        <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition shadow-sm">
  ...
  <div class="p-3 border-t border-white/10 bg-white/5 backdrop-blur-sm shrink-0 flex items-center justify-between gap-2">
    ...
    <a href="<?php echo e(url('/settings')); ?>" class="flex-1 flex items-center justify-center h-10 rounded-xl bg-white/15 hover:bg-white/25 text-white transition-all duration-200 border border-white/10 shadow-xs group" title="Pengaturan (Settings)" aria-label="Settings">
...
<?php /**PATH C:\laragon\www\dashboard_dekan_fmipa\resources\views/layouts/navigation/sidebar.blade.php ENDPATH**/ ?>